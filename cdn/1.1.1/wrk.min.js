...
else{var wrk={};wrk.VERSION='v1.1.1';wrk.consoleLogHeader='  🔧🔧 ';wrk.consoleLogStyling='background-color: #9cc8ff; display: block';window.wrk=wrk;console.log(`%c  \n${wrk.consoleLogHeader} wrk.js ${wrk.VERSION}  \n  `,wrk.consoleLogStyling);Object.getOwnPropertyNames(Math).forEach(key=>{wrk[key]=Math[key];});}
...
wrk.Sound=class extends Audio{constructor(url){super(url);}
...
setGlobalPosition(position){this.position=wrk.v.copySub(position,this.parent.globalPosition);}
